      ...
      <header className="relative z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg px-4 md:px-6 py-4 flex flex-col sm:flex-row items-center justify-between sticky top-0 rounded-b-lg gap-4 sm:gap-0">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <div className="relative" ref={profileMenuRef}>
            ...
            >
              <User size={18} sm={20} /> {/* Adjust icon size */}
            </button>
            {profileMenuOpen && (
              <div className="absolute right-0 mt-3 w-48 sm:w-56 rounded-xl bg-white dark:bg-gray-800 shadow-xl z-50 overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                >
                  <User size={16} sm={18} /> {/* Adjust icon size */}
                  View Profile
                </button>
                <button
                  onClick={toggleTheme}
                ...
                >
                  <LogOut size={16} sm={18} /> {/* Adjust icon size */}
                  End Session
                </button>
              </div>
            )}
      ...
      <main className="relative z-30 max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <DashboardCard
            ...
            icon={<Home size={24} sm={28} className="text-white" />} // Adjust icon size
          ...
          <DashboardCard
            ...
            icon={<DoorOpen size={24} sm={28} className="text-white" />} // Adjust icon size
